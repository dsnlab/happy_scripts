%-----------------------------------------------------------------------
% Job saved on 07-Jan-2019 14:12:17 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.util.exp_frames.files = {'/projects/dsnlab/shared/FP/bids_data/derivatives/fmriprep/sub-FP001/ses-wave1/func/s2_sub-FP001_ses-wave1_task-SVC_acq-01_bold_space-T1w_preproc.nii'};
matlabbatch{1}.spm.util.exp_frames.frames = Inf;
matlabbatch{2}.spm.util.exp_frames.files = {'/projects/dsnlab/shared/FP/bids_data/derivatives/fmriprep/sub-FP001/ses-wave1/func/s2_sub-FP001_ses-wave1_task-SVC_acq-02_bold_space-T1w_preproc.nii'};
...
matlabbatch{4}.spm.stats.fmri_spec.dir = {'/projects/dsnlab/shared/FP/nonbids_data/fMRI/fx/models/svc/wave1/betaseries/sub-FP001'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(1).multi = {'/projects/dsnlab/shared/FP/FP_scripts/fMRI/fx/multiconds/svc/wave1/betaseries/FP001_wave1_SVC1.mat'};
...
matlabbatch{4}.spm.stats.fmri_spec.sess(2).multi = {'/projects/dsnlab/shared/FP/FP_scripts/fMRI/fx/multiconds/svc/wave1/betaseries/FP001_wave1_SVC2.mat'};
