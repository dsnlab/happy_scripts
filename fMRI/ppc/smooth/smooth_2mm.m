%-----------------------------------------------------------------------
% Job saved on 29-Dec-2018 12:42:39 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 'sub-FP001_ses-wave1_task-SVC_acq-01_bold_space-MNI152NLin2009cAsym_preproc.nii.gz';
...
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 'sub-FP001_ses-wave1_task-SVC_acq-02_bold_space-MNI152NLin2009cAsym_preproc.nii.gz';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{3}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (sub-FP001_ses-wave1_task-SVC_acq-01_bold_space-MNI152NLin2009cAsym_preproc.nii.gz)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (sub-FP001_ses-wave1_task-SVC_acq-02_bold_space-MNI152NLin2009cAsym_preproc.nii.gz)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
