...
codedir = os.path.join(os.sep, "projects", group, "shared", study, "FP_scripts", "org", parent_dir, "conversion")  # Contains subject_list.txt, config file, and dcm2bids_batch.py
