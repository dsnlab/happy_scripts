...
lhannots=`cat lhannots.txt` #`cat lhannots_aparc.txt`
rhannots=`cat rhannots.txt` #`cat rhannots_aparc.txt`
lhlabels=`cat lhlabels.txt` #`cat lhlabels_aparc.txt`
rhlabels=`cat rhlabels.txt` #`cat rhlabels_aparc.txt`
